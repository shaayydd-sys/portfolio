    ...
    return (
        ...
        >
            ...
            <div className="hidden min-[900px]:flex items-center gap-8 font-data text-sm uppercase">
                <a href="#about" className={`hover-lift transition-colors ${isDarkText ? 'text-dark/80 hover:text-accent' : 'text-primary/80 hover:text-primary'}`}>About Me</a>
                <a href="#experience" className={`hover-lift transition-colors ${isDarkText ? 'text-dark/80 hover:text-accent' : 'text-primary/80 hover:text-primary'}`}>Experience</a>
                <a href="#skills" className={`hover-lift transition-colors ${isDarkText ? 'text-dark/80 hover:text-accent' : 'text-primary/80 hover:text-primary'}`}>Skills</a>
                <a href="#projects" className={`hover-lift transition-colors ${isDarkText ? 'text-dark/80 hover:text-accent' : 'text-primary/80 hover:text-primary'}`}>Projects</a>
            </div>
            <a href="#contact" className="relative overflow-hidden group px-4 py-1.5 md:px-6 md:py-2.5 rounded-full font-heading font-semibold text-xs md:text-sm transition-all duration-300 hover:scale-[1.03] hover:shadow-[0_10px_20px_rgba(230,59,46,0.15)] bg-[#1a1a1a] [transform:translateZ(0)]">
                ...
                <span className="relative z-10 block transition-colors duration-300 text-primary group-hover:text-dark">CONTACT ME</span>
            </a>
        </nav>
    );
}
